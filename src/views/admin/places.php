...
echo Html::a(FontAwesome::icon('plus') . " добавить площадку", null, [
    'onclick' => ModalWindow::showForm('banner/admin/place-form', 0),
    ...
    'columns' => [
        ...
        [
            ...
            'content' => function (AdsPlace $model) {
                return
                    Html::a(FontAwesome::icon('pencil'), NULL, ['onclick' => ModalWindow::showForm('banner/admin/place-form', $model->id), 'class' => 'btn btn-default btn-sm']) . " " .
                    Html::a(FontAwesome::icon('trash'), NULL, ['onclick' => ModalWindow::deleteItem('banner/admin/place-delete', $model->id), 'class' => 'btn btn-default btn-sm']);
            },
        ]
    ]
]);
